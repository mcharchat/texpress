...
export default function CreatePostDialog({
	...
	return (
		<Dialog
			...
			handler={handleopenCreatePostDialog}
			size='xxl'
		>
			<DialogHeader>
			...
			>
				<div className='flex flex-col gap-4'>
					...
					<MenuWithCheckbox
						...
						selectedOptions={postData.categories.map((category) => category.id)}
